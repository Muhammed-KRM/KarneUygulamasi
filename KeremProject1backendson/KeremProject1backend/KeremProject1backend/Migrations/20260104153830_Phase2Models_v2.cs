...
{
    /// <inheritdoc />
    public partial class Phase2Models_v2 : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Type = table.Column<byte>(type: "tinyint", nullable: false),
                    ClassroomId = table.Column<int>(type: "int", nullable: true),
                    AnswerKeyJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LessonConfigJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BookletType = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    DetailedResultsJson = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    ...
                    InstitutionRank = table.Column<int>(type: "int", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ExamResults_StudentNumber",
                table: "ExamResults",
